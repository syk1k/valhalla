...
#define LOG_ERROR(x)                                                                                 \
  ::valhalla::midgard::logging::GetLogger().Log(std::string(__FILE__) + std::to_string(__LINE__) + x, ::valhalla::midgard::logging::LogLevel::ERROR)
#else
#define LOG_ERROR(x)
#endif
#ifdef LOGGING_LEVEL_WARN
#define LOG_WARN(x)                                                                                  \
  ::valhalla::midgard::logging::GetLogger().Log(std::string(__FILE__) + std::to_string(__LINE__) + x, ::valhalla::midgard::logging::LogLevel::WARN)
#else
#define LOG_WARN(x)
#endif
#ifdef LOGGING_LEVEL_INFO
#define LOG_INFO(x)                                                                                  \
  ::valhalla::midgard::logging::GetLogger().Log(std::string(__FILE__) + std::to_string(__LINE__) + x, ::valhalla::midgard::logging::LogLevel::INFO)
#else
#define LOG_INFO(x) ;
#endif
#ifdef LOGGING_LEVEL_DEBUG
#define LOG_DEBUG(x)                                                                                 \
  ::valhalla::midgard::logging::GetLogger().Log(std::string(__FILE__) + std::to_string(__LINE__) + x, ::valhalla::midgard::logging::LogLevel::DEBUG)
#else
#define LOG_DEBUG(x)
#endif
#ifdef LOGGING_LEVEL_TRACE
#define LOG_TRACE(x)                                                                                 \
  ::valhalla::midgard::logging::GetLogger().Log(std::string(__FILE__) + std::to_string(__LINE__) + x, ::valhalla::midgard::logging::LogLevel::TRACE)
#else
#define LOG_TRACE(x)
#endif
#endif
